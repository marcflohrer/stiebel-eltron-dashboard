...
```keyvaluepair
DatabaseConnectionString="Host=db;Database=postgres;Username=postgres;Password=MySuperSecretPassword;SslMode=Disable"
```
...
{
    "DatabasePassword": "<MySuperSecretPassword>",
    "DefaultConnection": "Host=localhost;Database=postgres;Username=postgres;Password=<MySuperSecretPassword>;SslMode=Disable",
    "ServiceWeltUser": "<serviceweltusername>",
    "ServiceWeltPassword": "<serviceweltpassword>",
    "ServiceWeltUrl": "<servicewelturl>",
    "HttpPort": "<httpPort>",
