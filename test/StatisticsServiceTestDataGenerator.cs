    ...
    private static readonly List<object[]> _data = new List<object[]> {
        new object[]
        {
            ...
            new HeatPumpDataPerPeriod {
                PeriodStart = DateTimeExtensions.EnsureDateTimeIsUtc(new DateTime(2021,1,13, 0, 0, 0)),
                PeriodEnd = DateTimeExtensions.EnsureDateTimeIsUtc(new DateTime(2021,1,14, 0, 0, 0)),
                ...
                PeriodKind = "Day",
                PeriodNumber = 13,
                First = DateTimeExtensions.EnsureDateTimeIsUtc(new DateTime(2021,5,1).Subtract (TimeSpan.FromHours (14))),
                Last = DateTimeExtensions.EnsureDateTimeIsUtc(new DateTime(2021,5,1).Subtract (TimeSpan.FromHours (1))),
                DateUpdated = DateTimeExtensions.EnsureDateTimeIsUtc(new DateTime(2021,4,30,10,0,0)),
                DateCreated = DateTimeExtensions.EnsureDateTimeIsUtc(new DateTime(2021,4,30,10,0,0)),
            }
        }
    };
