        ...
        public HeatPumpDataPerPeriod GetHeatPumpDataPerPeriod (IEnumerable<HeatPumpDatum> heatPumpData, int year, string periodKind, int periodNumber, DateTime now) {
            ...
            var result = new HeatPumpDataPerPeriod () {
                ReturnTemperatureMin = heatPumpData.GetMinForMetric (h => h.ReturnTemperature) ?? Double.MinValue,
                    ...
                    VaporizerHeatQuantityHeatingDayMin = heatPumpData.GetMinForMetric (h => h.VaporizerHeatQuantityHeatingDay)?? Double.MinValue,
                    VaporizerHeatQuantityHeatingDayMax = heatPumpData.GetMaxForMetric (h => h.VaporizerHeatQuantityHeatingDay)?? Double.MinValue,
                    VaporizerHeatQuantityHeatingDayAverage = heatPumpData.GetAverageForMetric (h => h.VaporizerHeatQuantityHeatingDay)?? Double.MinValue,
                    ...
                    VaporizerHeatQuantityHotWaterDayMin = heatPumpData.GetMinForMetric (h => h.VaporizerHeatQuantityHotWaterDay)?? Double.MinValue,
                    VaporizerHeatQuantityHotWaterDayMax = heatPumpData.GetMaxForMetric (h => h.VaporizerHeatQuantityHotWaterDay)?? Double.MinValue,
                    VaporizerHeatQuantityHotWaterDayAverage = heatPumpData.GetAverageForMetric (h => h.VaporizerHeatQuantityHotWaterDay)?? Double.MinValue,
                    ...
                    PowerConsumptionHeatingDayMin = heatPumpData.GetMinForMetric (h => h.PowerConsumptionHeatingDay)?? Double.MinValue,
                    PowerConsumptionHeatingDayMax = heatPumpData.GetMaxForMetric (h => h.PowerConsumptionHeatingDay)?? Double.MinValue,
                    PowerConsumptionHeatingDayAverage = heatPumpData.GetAverageForMetric (h => h.PowerConsumptionHeatingDay)?? Double.MinValue,
                    ...
                    PowerConsumptionHotWaterDayMin = heatPumpData.GetMinForMetric (h => h.PowerConsumptionHotWaterDay)?? Double.MinValue,
                    PowerConsumptionHotWaterDayMax = heatPumpData.GetMaxForMetric (h => h.PowerConsumptionHotWaterDay)?? Double.MinValue,
                    PowerConsumptionHotWaterDayAverage = heatPumpData.GetAverageForMetric (h => h.PowerConsumptionHotWaterDay)?? Double.MinValue,
