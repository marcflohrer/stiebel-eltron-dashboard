    ...
    public class HeatPumpStatisticsPerPeriodRepository : IHeatPumpStatisticsPerPeriodRepository {
        ...
        public List<HeatPumpDataPerPeriod> GetRecentSevenDays(DateTime now)
        {
            ...
            if(yearOfFirstDay != yearOfLastDay){
                ...
                Log.Information("Number of days found in old year: " + resultList.Count());
                Log.Information("Number of days found in new year: " + listInNewYear.Count());
                
                resultList.AddRange(listInNewYear.ToList());
                
                Log.Information("Number of days found in both years: " + resultList.Count());
            }
        ...
        public List<HeatPumpDataPerPeriod> GetRecentTwelveWeeks(DateTime now, CultureInfo cultureInfo)
        {
            ...
            if(yearOfFirstWeek != yearOfLastWeek){
                ...
                Log.Information("Number of weeks found in old year: " + resultList.Count());
                Log.Information("Number of weeks found in new year: " + listInNewYear.Count());

                resultList.AddRange(listInNewYear);

                Log.Information("Number of weeks found in both years: " + resultList.Count());
            }
            return resultList;                               
        }
        ...
        public List<HeatPumpDataPerPeriod> GetRecentTwelveMonths(DateTime now)
        {
            ...
            if(yearOfFirstMonth != yearOfLastMonth){
                ...
                Log.Information("Number of months found in old year: " + resultList.Count());
                Log.Information("Number of months found in new year: " + listInNewYear.Count());

                resultList.AddRange(listInNewYear);

                Log.Information("Number of months found in both years: " + resultList.Count());
            }
