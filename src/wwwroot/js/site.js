...
function drawChartBase(period, chartName, chartTitle, labels, dataSets, chartType) {
...
function drawMinMaxChartInternal(period, chartName, chartTitle, labels, maxYs, maxYsColors, averageYs, averageYsColor, minYs, minYsColor) {
    ...
    drawChartBase(period, chartName, chartTitle, labels, dataSets, 'line');
}
...
function drawBarChartInternal(period, chartName, chartTitle, labels, Ys, YsColors) {
    var dataSets = getDataSets(["Mittel"],[Ys],[YsColors],['rgba(140, 173, 88, 1)'],false,0,0);
    drawChartBase(period, chartName, chartTitle, labels, dataSets, 'bar');
}
